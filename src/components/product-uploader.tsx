...
import DevModal from "./dev-cmp/modal";
        ...
        setTimeout(() => {
          ...
          setTimeout(async () => {
            ...
            const analysisResult = await ImageTxtModal(
              file,
              `When I upload a product image, analyze it and generate a JSON array of objects with the following structure and you can add extra appropiate enum based on product and directly give me array and dont give me extra words because i will direclty parse it:

  [
      {
        "label": "Category",
        "value": "string",      // Enum: ["Shoes", "Apparel", "Accessories", "Equipment"]
      },
      {
        "label": "Sub category",
        "value": "string",      // For Shoes: ["Sneaker", "Boot", "Sandal", "Formal", "Athletic"]
      },
      {
        "label": "Age Group",
        "value": "string",      // Enum: ["Adult", "Teen", "Kids", "Toddler", "Infant"]
      },
      {
        "label": "Gender",
        "value": "string",      // Enum: ["Men", "Women", "Unisex"]
      },
      {
        "label": "Tier",
        "value": "string",      // Enum: ["Premium", "Standard", "Budget"]
      },
      {
        "label": "Color Schemes",
      ...
      {
        "label": "Eco friendly",
        "value": "string",      // Enum: ["Yes", "No"]
      },
      {
        "label": "Interests",
        "value": "string",      // Enum: ["Outdoor", "Sports", "Casual", "Fashion", "Performance"]
      }
    ]
  ...
  `
            ...
            setJsonData(JSON.parse(analysisResult))
